...
Note: The Regression Analysis relies on Python 3 to preform regression analysis and build visuals. To run on a local server, Python must
be able to access the following modules: sqlite3, numpy, scipy, pandas, matplotlib, statsmodels, seaborn, mpld3
The Regression Analysis Template is written in php5 with sqlite3 enabled. To run on a localhost, the document root must be changed to 
